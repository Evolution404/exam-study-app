...
import type { Attempt, ContentBlock, Question, ReviewRoundProgress } from "../../src/lib/db/types";
...
const scopedAttempt = (id: string, questionId: string, createdAt: string, correct: boolean, selected = "A"): Attempt => ({
