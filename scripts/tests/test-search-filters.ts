...
assert.match(searchViewSource, /showResults && views !== undefined \? readSearchHistoryDataV7\(appliedQuestions\) : null/, "空搜索主页不得提前 materialize 作答历史和轮次进度，且搜索后只能读取当前筛选范围");
