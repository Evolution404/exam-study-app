...
const deleteAnswer = await createChangeSet({ id: "delete-answer", deviceId: "device-a", localSequence: 1, createdAt: at, mutation: { kind: "practice.answer.deleted", attemptId: attempt.id, runId: run.id, questionId: question.id, deletedAt: at } });
...
const staleSubmit = await createChangeSet({ id: "stale-submit", deviceId: "device-b", localSequence: 1, createdAt: at, mutation: { kind: "practice.answer.submitted", attempt: { ...attempt, deviceId: "device-b" }, answer: { ...answer, deviceId: "device-b" }, runId: run.id, questionId: question.id } });
