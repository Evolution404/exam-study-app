...
assert.match(practiceView, /question\.type === "计算" \? \(!hasInlineCalculationBlanks && <div className=\{`calculation-answer fallback-grid/, "calculations without inline blanks must render their dedicated answer card");
