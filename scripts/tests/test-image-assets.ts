...
assert.equal(remoteAssetPath(digest, "image/webp"), `sync/v6/assets/${digest}.webp`);
assert.equal(remoteAssetPath(digest, "image/jpeg"), `sync/v6/assets/${digest}.jpg`);
assert.equal(remoteAssetPath(digest, "image/png"), `sync/v6/assets/${digest}.png`);
