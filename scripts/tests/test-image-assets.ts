...
assert.equal(remoteAssetPath(digest, "image/webp"), `sync/v7/assets/${digest}.webp`);
assert.equal(remoteAssetPath(digest, "image/jpeg"), `sync/v7/assets/${digest}.jpg`);
assert.equal(remoteAssetPath(digest, "image/png"), `sync/v7/assets/${digest}.png`);
