...
const SYNC_ERRORS: string[] = [
  ...
  "v8 publication vault identity mismatch",
  "v8 segment vault identity mismatch",
  "v8 segment vault identity does not match head",
  ...
  "GitHub read v8 head failed (404)",
  "GitHub put immutable sync/v8/objects/abc.json failed (422)",
  "v8 segments exceed the aggregate hot-window byte limit; compact explicitly first",
  "v8 segments exceed the bounded index limit",
  "v8 replay contains duplicate generation/ordinal",
  "v8 segment generation mismatch",
  "v8 segment ordinal mismatch",
  "immutable v8 file content differs at sync/v8/objects/abc.json",
  "v8 blob size mismatch: expected 1024, received 2048",
  "v8 blob sha256 mismatch: expected aaaa, received bbbb",
  "object ref path digest must equal sha256",
  "invalid v8 segment envelope",
  "invalid v8 segment JSON",
  "远程 v7 检查点不是有效 JSON。",
  "正则表达式格式不正确，请检查后重试",
  "题库导入失败",
  "本地缓存恢复失败",
