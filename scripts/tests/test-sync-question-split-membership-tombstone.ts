...
const bank: BankV6 = { id: "bank-1", name: "基础题库", sortOrder: 0, questionCount: 2, importedAt: at, updatedAt: at, deviceId: "seed" };
const question: QuestionV6 = { id: "question-1", type: "单选", content: [{ id: "stem-0", type: "text", text: "原始题" }], options: [[{ id: "a", type: "text", text: "A" }], [{ id: "b", type: "text", text: "B" }]], answer: "A", tags: [], contentFingerprint: "fingerprint-1", updatedAt: at, deviceId: "device-a" };
const clone: QuestionV6 = { id: "question-2", type: "单选", content: [{ id: "stem-0", type: "text", text: "分裂题" }], options: [[{ id: "a", type: "text", text: "A" }], [{ id: "b", type: "text", text: "B" }]], answer: "A", tags: [], contentFingerprint: "fingerprint-2", updatedAt: at, deviceId: "device-a" };
