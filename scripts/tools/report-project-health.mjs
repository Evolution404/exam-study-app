...
const focus = [
  ...
  "src/lib/sync/change-set-codec.ts",
  "src/lib/sync/change-set-planning.ts",
  "src/lib/sync/change-set-reducer.ts",
  "src/lib/sync/sync-checkpoint-validation.ts",
  "src/lib/sync/sync-checkpoint-store.ts",
  "src/lib/sync/sync-head-validation.ts",
  "src/lib/sync/sync-head-operations.ts",
  "src/lib/sync/sync-orchestrator.ts",
  "src/lib/sync/github-remote.ts",
