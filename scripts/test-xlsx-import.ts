...
assert.deepEqual(rows[0].slice(0, 9), ["题干", "题型", "答案", "标签", "A", "B", "C", "D", "E"]);
...
const questions = parseQuestionBankTable([
  ["题干", "题型", "答案", "标签", "A", "B", "C", "D"],
  ["单选题", "单选", "B", "基础", "选项一", "选项二", "选项三", "选项四"],
  ["多选题", "多选", "C、A", "", "甲", "乙", "丙", "丁"],
  ["判断题", "判断", "正确", "判断", "正确", "错误"],
  ["计算题", "计算", "12.5", "计算"],
]);
assert.deepEqual(questions, [
  { q: "单选题", ans: "B", a: ["选项一", "选项二", "选项三", "选项四"], type: "单选", tags: ["基础"] },
  { q: "多选题", ans: "AC", a: ["甲", "乙", "丙", "丁"], type: "多选", tags: [] },
  { q: "判断题", ans: "A", a: ["正确", "错误"], type: "判断", tags: ["判断"] },
  { q: "计算题", ans: "12.5", a: [], type: "计算", tags: ["计算"] },
]);

const extendedOptions = parseQuestionBankTable([
  ["题干", "题型", "答案", "标签", "A", "B", "C", "D", "E", "F", "G", "H"],
