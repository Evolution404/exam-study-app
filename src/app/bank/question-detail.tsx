...
import { loadImageAsset, type QuestionViewModel } from "@/app/bank/question-editor";
import { difficultyLabel, type AttemptSummary } from "@/lib/practice/practice-metrics";
import type { PracticeRun } from "@/lib/db/types";
...
export function QuestionDetail({ question, metric, scopeLabel, note, onClose, footer, metadata, nav, answer, answerLabel = "你的答案" }: {
  ...
  footer?: ReactNode;
  metadata?: ReactNode;
  answer?: PracticeRun["answers"][string];
  answerLabel?: string;
  nav?: {
    index: number;
    total: number;
