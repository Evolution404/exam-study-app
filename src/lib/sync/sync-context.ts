...
export function remote(settings: GitHubSettings, token: string, fetchImpl?: SyncWithGitHubOptions["fetch"], transport = getGitHubTransport()): GitHubRemote {
...
export function descriptorEqual(a: SyncDescriptor, b: SyncDescriptor): boolean {
...
export const SYNC_DOWNLOAD_CONCURRENCY = 6;
